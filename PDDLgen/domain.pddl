; 11/03/2017 - Domain 7 (ECAI submission)
...
(:action is-guaranteed-against
    :parameters (?A - agent)
    :precondition (and (= (stage) 2)
                       (not (unguaranteed ?A))
                   )
